...
const CHAPTER_ZONES = {
  ...
  f3:'sunday', f4:'sunday', s1:'sunday', m1:'sunday', d1:'sunday', g1:'sunday',
  f8:'sunday', f12:'sunday',

  // ACADEMY (unlockAt:5)
  t1:'academy', t2:'academy', t3:'academy',
...
const ZONE_CHAPTERS = {
  ...
  sunday:     ['f3','f4','s1','m1','d1','g1','f8','f12'],
  academy:    ['t1','t2','t3','f6','f7','f9','s2','s3','w1','w2','fb1','fb2','mi2','mi3','gk2_dist','gk3_box','gk4_1v1','d2'],
